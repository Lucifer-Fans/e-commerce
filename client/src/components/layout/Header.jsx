...
export default function Header() {
  ...
  // On the routes that drop the bottom bar, these two come back up here on
  // mobile; everywhere else they stay desktop-only.
  ...
  return (
    /* Sticky so search and the account menu are always one tap away while browsing. */
      ...
      <div className="relative z-20 bg-ink-900 text-white">
        <div className="container-page flex items-center gap-3 py-3 lg:gap-6">
          ...
          <div className="ml-auto flex items-center gap-1 sm:gap-2">
            ...
            {/* Below `lg` these two usually live in the fixed bottom bar instead. */}
            <NavLink
              to="/wishlist"
              className={`relative rounded-lg p-2 hover:bg-white/10 ${shopIconClass}`}
