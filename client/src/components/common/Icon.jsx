...
const PATHS = {
  ...
  eyeOff:
    'M17.9 17.9A10.1 10.1 0 0112 20C5 20 1 12 1 12a18.5 18.5 0 015.1-5.9m3.8-2A9.1 9.1 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.2 3.2M14.1 14.1a3 3 0 11-4.2-4.2M1 1l22 22',
  ...
  // Solid triangle — render it with `filled`, over a video poster frame.
